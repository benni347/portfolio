    ...
    return (
        <Layout title="Learning">
            <Container>
                ...
                <P>
                    I&apos;m currently learning python on code chef it&apos;s a
                    platform which I kinda don&apos;t like to much because their
                    solutions to some problems are wrong. I also always write up
                    my solution you can find it here:{" "}
                    <a href={solutionUrl}>Solutions</a>, but that are just the
