  ...
  return (
    <Layout title="Certificates">
      <Container>
        ...
        <P>
          The Scientific Computing Python required me to write five projects.
          The hardest part for me was the vertical text output. The second most
          hardest thing was right aligning the text for the exercise Arithmetic
          Formatter.
        </P>
        <List ml={4} my={4}>
          <ListItem>
