    ...
    return (
        <Layout title="Certificates">
            <Container>
                ...
                <P>
                    The python coding game was similair to the{" "}
                    <Link href="./goCodingGame.js">go coding game</Link>, since
                    it had the same questions.
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                    ...
                    <ListItem>
                        <Meta>Download</Meta>
                        <DownloadLink
                            imageName="python_coding_game.avif"
